if defined?(EventMachine.library_type) and EventMachine.library_type == :pure_ruby
  # assume 'script/lib/em/pure_ruby' was loaded already
  ...
  begin
    ...
    warn "Unable to load the EventMachine C extension; To use the pure-ruby reactor, require 'script/lib/em/pure_ruby'"
    raise
  end
end

require 'script/lib/em/version'
require 'script/lib/em/pool'
require 'script/lib/em/deferrable'
require 'script/lib/em/future'
require 'script/lib/em/streamer'
require 'script/lib/em/spawnable'
require 'script/lib/em/processes'
require 'script/lib/em/iterator'
require 'script/lib/em/buftok'
require 'script/lib/em/timers'
require 'script/lib/em/protocols'
require 'script/lib/em/connection'
require 'script/lib/em/callback'
require 'script/lib/em/queue'
require 'script/lib/em/channel'
require 'script/lib/em/file_watch'
require 'script/lib/em/process_watch'
require 'script/lib/em/tick_loop'
require 'script/lib/em/resolver'
require 'script/lib/em/completion'
require 'script/lib/em/threaded_resource'
